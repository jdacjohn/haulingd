...
<head>
	...
	<title>Boat & Yacht Shipping Quotes | Free Boat Moving Quotes</title>
...
<div class='main-wrapper content'>
	<section class="relative software_slider" style="padding-top:105px;background: url('img/3284.jpg') no-repeat fixed 0px -170px / 100% auto">
                  ...
                  <td><center><div class="relative" style="width: 80%;">
                    ...
                    <div class="relative" style="width: 80%;">
										<select class="styled" style="color:#717171;" name="vehicle_condition1">
                                            <option value="Operational">Select Boat Condition:</option>
