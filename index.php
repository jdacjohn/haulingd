...
<div class='main-wrapper content'>
	<section class="relative software_slider" style="background-position: 0px -184px;">
		<div class="forma-slider">
			<div class="container">
						...
						<ul class="form-bxslider list-unstyled">
							<li>
								<div class="list-forstart fin_1">
									<h2 class='h-Bold'>Vehicle Shipping</h2>
									<p class='desc'>Get Your Car Shipped Today!</p>
									<ul class='ul-list-slider Open-sansR'>
										<li>Bonded & Insured.</li>
										<li>Live Assistant, Call Anytime.</li>
										<li>Competative Pricing.</li>
							...
							<li>
								<div class="list-forstart fin_1">
									<h2 class='h-Bold'>Motorcycle Shipping</h2>
								   <!--	<p class='desc'>Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum.</p>-->
									<ul class='ul-list-slider Open-sansR'>
										<li>Bonded & Insured.</li>
										<li>Personal transport manager, call anytime.</li>
										<li>Job Insured up to $250,000</li>
										<li>Best prices on the market.</li>
									</ul>
								</div>
							...
							<li>
								<div class="list-forstart fin_1">
									<h2 class='h-Bold'>Boat Shipping</h2>
									<ul class='ul-list-slider Open-sansR'>
										<li>Bonded & Insured.</li>
										<li>Personal transport manager, call anytime.</li>
										<li>Job Insured up to $250,000</li>
              ...
              <li>
								<div class="list-forstart fin_1">
									<h2 class='h-Bold'>RV Shipping</h2>
									<ul class='ul-list-slider Open-sansR'>
										<li>Bonded & Insured.</li>
										<li>Personal transport manager, call anytime.</li>
										<li>Job Insured up to $250,000</li>
								...
								<div class="img-slider hidden-xs slide-man4 fin_2"></div>
							</li>
						</ul>
						<div class="bx-controls bx-has-pager bx-has-controls-direction" id='dafault_pager'>
							<div class="bx-pager bx-default-pager">
								<div class="bx-pager-item">
									<a class="bx-pager-link pager-Ico1" data-slide-index="0" href="vehicle-shipping.php"><span>Vehicle</span></a>
								</div>

								<div class="bx-pager-item">
									<a class="bx-pager-link pager-Ico2" data-slide-index="1" href="motorcycle-shipping.php"><span>Motorcycle</span></a>
								</div>
                <div class="bx-pager-item">
									<a class="bx-pager-link pager-Ico3" data-slide-index="2" href="boat-shipping.php"><span>Boat</span></a>
								</div>
                <div class="bx-pager-item">
									<a class="bx-pager-link pager-Ico4" data-slide-index="3" href="rv-shipping.php"><span>RV</span></a>
								</div>

								<div class="bx-pager-item lastItem">
									<a class="bx-pager-link pager-Ico5" data-slide-index="4" href="trailer-shipping.php"><span>Eqip.</span></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container relative fin_3" id='elem-portable'>
						<div class="reg-now">
							<h2 class='medium-h text-center'>Compare 5 Free Quotes</h2>
							<h3 class='xsmall-h text-center'>Instant & Secure. </h3>
							<form action="vehicle-shipping.php" method="post" id="ship">
                <div class="relative">
									<select id="selectType" name="caoch" class="styled" onChange="aUpdate()">
										<option value="vehicle-shipping.php">I am shipping a...</option>
										<option value="vehicle-shipping.php">Vehicle</option>
										<option value="motorcycle-shipping.php">Motorcycle</option>
										<option value="boat-shipping.php">Boat</option>
										<option value="rv-shipping.php">RV</option>
										<option value="trailer-shipping.php">Trailer & Equipment</option>
									</select>
								</div>
                <!--   <div class="relative">
                  ...
                  <input id="geocomplete" class="controls" type="text" placeholder="From Zipcode or City/State" name="from">
        <div class="fromDetails">
        <input type="text" value="" name="name" hidden="hidden">
        <input type="text" value="" name="formatted_address" hidden="hidden">
        <input type="text" value="" name="route" hidden="hidden">
        <input type="text" value="" name="street_number" hidden="hidden">
        <input id="fromZip" type="text" value="" name="postal_code" hidden="hidden">
        <input id="fromCity" type="text" value="" name="locality" hidden="hidden">
        <input type="text" value="" name="sublocality" hidden="hidden">
        <input type="text" value="" name="country" hidden="hidden">
        <input id="countryS" type="text" value="US" name="country_short" hidden="hidden">
        <input id="fromState" type="text" value="" name="administrative_area_level_1" hidden="hidden">
        </div>
        <div class="toDetails">
        <input type="text" value="" name="name" hidden="hidden">
        <input type="text" value="" name="formatted_address" hidden="hidden">
        <input type="text" value="" name="route" hidden="hidden">
        <input type="text" value="" name="street_number" hidden="hidden">
        <input id="toZip" type="text" value="" name="postal_code" hidden="hidden">
        <input id="toCity" type="text" value="" name="locality" hidden="hidden">
        <input type="text" value="" name="sublocality" hidden="hidden">
        <input type="text" value="" name="country" hidden="hidden">
        <input id="countryS2" type="text" value="" name="country_short" hidden="hidden">
        <input id="toState" type="text" value="" name="administrative_area_level_1" hidden="hidden">
        </div>
				<input id="geocomplete2" class="controls" type="text" placeholder="To Zipcode or City/State" name="to">
				</div>
        <!--   <div class='control-group'>
								...
								<div class='control-group'>
								 ...
								 <button id="mySubmit" type="submit" value="Register Now" class='btn submit sub-form'>Get your free quotes now</button>
							</form>
						</div>
					</div>
				</div>
...
<footer class='main-wrapper footer'>
	...
	<div class="container" style="display: table;margin-top: 87px;">
...
<div id="myModal" class="modal fade" tabindex="-1" aria-hidden="true">
	<div class="modal-wr">
		...
		<form id='contact' action="request-form.php" method="post" accept-charset="utf-8" role="form">
            ...
            <img src="img/important_svg.png" style="width:20px;"> Brokers, contact us about leads <a href="brokers.php" style="color:#FF2777;">here</a>.<br><br>
			<div class='control-group'>
...
<script src="js/ubilabs-geocomplete-d026f14/jquery.geocomplete.min.js"></script>
