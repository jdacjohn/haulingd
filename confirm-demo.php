...
$arrVars = array(
'leadid' => $lead_id_is_auth
, 'vehicle_year' => 2010
, 'vehicle_make' => 'Honda'
, 'vehicle_model' => 'Accord Crosstour EX-L AWD'
, 'vehicle_condition1' => 'Operational'
, 'vehicle_year2' => ''
, 'vehicle_make2' => ''
, 'vehicle_model2' => ''
, 'vehicle_condition2' => ''
, 'vehicle_pickup_location' => 'Orange 06477'
, 'vehicle_pickup_state' => 'CT'
, 'vehicle_destination_city' => 'Milford 06461'
, 'vehicle_destination_state' => 'CT'
, 'flexable_move' => ''
, 'carrier_type' => ''
, 'carrier_type2' => ''
, 'customername' => 'Test'
	...
	require('_includes/processClass.inc.php');
        ...
        if ($arrVars['moving'] == "checked"){
         rename('_config/temp.inc.php', '_config/config.inc.php');
          $murl= "http://www.haulingdepot.com/contactform_movingc-demo.php";
          $fields = array (
