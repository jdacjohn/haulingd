...
require_once('_includes/noconfig.project.inc.php');$gDebug = true;
?>
<?php
//require_login();
...
header( 'Location: http://www.haulingdepot.com/confirm-demo.php?passcode='.$password.'&email='.$arrVals['email'].'' ) ;
}
