<?php
require_once('configs/motorc/config.inc.php');
...
<div class='main-wrapper content'>
	<section class="relative software_slider" style="padding-top:105px;background: url('img/51a990d9f3ec861517.jpg') no-repeat fixed 0px -200px / 100% auto">
        ...
        <input type="text" id="toState" value="<?php if (isset($_POST['toState']) && !empty($_POST['toState'])) { echo $_POST['toState']; } ?>" name="administrative_area_level_1" hidden="hidden">
                        ...
                        <!--    <div class="relative">
                            ...
                            <!--<br><input type="checkbox" value="checked" id="moving" name="moving" <?php echo htmlspecialchars(getParam('moving')); ?>>Please also send me a home mover quote.-->
                            <br><br>
                            </div>
                              <!--   <div class='control-group'>
