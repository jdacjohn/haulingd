...
<head>
	...
	<title>Motorcycle Shipping Quotes | Free Vehicle Transport Quotes</title>
...
<div class='main-wrapper content'>
	<section class="relative software_slider" style="padding-top:105px;background: url('img/51a990d9f3ec861517.jpg') no-repeat fixed 0px -60px / 100% auto">
		<div class="forma-slider">
			<div class="container">
				<div class="row">
					<div data-anchor="form_slider" id="form_slider">

						<div class="bx-wrapper" style="max-width: 100%;"><div style="width: 100%; overflow: hidden; position: relative; height: 480px;" class="bx-viewport">
              <form action="contactform_mc.php" method="post"><table style="width:100%;background-color:rgba(0, 0, 0, 0.3);;border-radius:14px;color:#FFFFFF;text-align:center;"><tbody><tr style="height:100px;vertical-align:top;"><td style="width:33%"><h1>Vehicle Information</h1></td><td style="width:33%"><h1>Trip Information</h1></td><td style="width:34%"><h1>Contact Details</h1></td></tr>
                <tr style="vertical-align:top;">
                  <td><center><div class="relative" style="width: 80%;">

                                        <input type="text" autocomplete="off" class="controls" placeholder="Enter Year" name="vehicle_year" required="required">


									</div>
                                    <br><br><div class="relative" style="width: 80%;">
                                    <input type="text" autocomplete="off" class="controls" placeholder="Enter Make" name="vehicle_make" required="required">
										</div>
                                    <br><br>
                                    <div class="relative" style="width: 80%;">
                                     <input type="text" autocomplete="off" class="controls" placeholder="Enter Model" name="vehicle_model" required="required">
                                        </div><br><br><br>

                    <div class="relative" style="width: 80%;">
										<select class="styled" style="color:#717171;" name="vehicle_condition1">
                                            <option value="Operational">Select Motorcycle Condition:</option>
                  ...
                  <td><div class="control-group">
                                       <input type="text" autocomplete="off" name="geocomplete" id="geocomplete" class="controls" placeholder="From Zipcode or City/State" style="width:80%" value="<?php if (isset($_POST['from']) && !empty($_POST['from'])) { echo $_POST['from']; } ?>" required="required">
                                       <br><a href="international-vehicle-shipping.php" style="color:#FFF;font-size:10px;position:relative;top:-10px;float:left;left:10%"><img src="img/global.png" style="width:18px;float:left;position:relative;float:left;">Click here if you are shipping from outside the United States</a>
        ...
        <input type="text" id="toState" value="<?php if (isset($_POST['toState']) && !empty($_POST['toState'])) { echo $_POST['toState']; } ?>" name="administrative_area_level_1" hidden="hidden">
                                       ...
                                       <input type="text" autocomplete="off" name="geocomplete2" id="geocomplete2" class="controls" placeholder="To Zipcode or City/State" style="width:80%" value="<?php if (isset($_POST['to']) && !empty($_POST['to'])) {  echo $_POST['to']; } ?>" required="required">
                                       ...
                                       <br><br><br><input type="text" class="datepicker" name="move_date" type="text" id="move_date" style="width:80%" placeholder="Estimated Move Date" required="required">
                                 ...
                                 <!--   <div class="relative">
                                    ...
                                    <div class="relative">
										<select name="caoch" class="styled">
                                         ...
                                         <input type="text" autocomplete="off" id="fullName" class="controls" placeholder="Full Name" style="width:80%" name="customername" required="required">
                                         <input type="text" autocomplete="off" id="phone" class="controls" placeholder="Phone Number" style="width:80%" name="phone" required="required"> <!-- data-pattnern="^[0-9]+$" -->
                                           <input type="text" autocomplete="off" id="email" class="controls" placeholder="Email Address" style="width:80%" name="email" required="required"> <!--  data-pattern="^[-a-z0-9!#$%&'*+/=?^_`{|}~]+(.[-a-z0-9!#$%&'*+/=?^_`{|}~]+)*@([a-z0-9]([-a-z0-9]{0,61}[a-z0-9])?.)*(aero|arpa|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel|[a-z][a-z])$" -->
                                           ...
                                           <textarea autocomplete="off" id="comments" class="controls" placeholder="Comments" style="width:80%" name="comments"></textarea>
