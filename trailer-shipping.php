<?php
require_once('configs/boatrv/config.inc.php');
...
if (getParam('frmSubmit') == 'true') {
	...
	if (strlen(trim($arrVals['customername'])) == 0) {
		...
		/*if (trim($arrVals['email'])!=trim($arrVals['email2'])){
			$arrErr[] = form_error('Email addresses do not match, please re-enter.', 'email');
		}*/
...
<head>
	...
	<title>Trailer & Equipment Shipping Quotes | Free Trailer & Equipment Quotes</title>
...
<div class='main-wrapper content'>
	<section class="relative software_slider" style="padding-top:105px;background: url('img/container-loading.jpg') no-repeat fixed 0px -100px / 100% auto">
              ...
              <form action="" method="post"><table style="width:100%;background-color:rgba(0, 0, 0, 0.3);;border-radius:14px;color:#FFFFFF;text-align:center;"><tbody><tr style="height:100px;vertical-align:top;"><td style="width:33%"><h1>Vehicle Information</h1></td><td style="width:33%"><h1>Trip Information</h1></td><td style="width:34%"><h1>Contact Details</h1></td></tr>
                <tr style="vertical-align:top;">
                  ...
                  <td><div class="control-group">
                                       <input type="text" autocomplete="off" name="from" id="geocomplete" class="controls" placeholder="From Zipcode or City/State" style="width:80%" value="<?php if (isset($_POST['from']) && !empty($_POST['from'])) { echo $_POST['from']; } ?>" required="required">
        ...
        <input type="text" id="toState" value="<?php if (isset($_POST['toState']) && !empty($_POST['toState'])) { echo $_POST['toState']; } ?>" name="administrative_area_level_1" hidden="hidden">
                                       ...
                                       <input type="text" autocomplete="off" name="to" id="geocomplete2" class="controls" placeholder="To Zipcode or City/State" style="width:80%" value="<?php if (isset($_POST['to']) && !empty($_POST['to'])) {  echo $_POST['to']; } ?>" required="required">
                                       ...
                                       <br><br><br><input type="text" class="datepicker" name="move_date" type="text" id="move_date" style="width:80%" placeholder="Estimated Move Date" data-value="<?php echo htmlspecialchars(getParam('move_date')); ?>" required="required">
