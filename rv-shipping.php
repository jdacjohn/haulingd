...
<head>
	...
	<title>RV Shipping Quotes | Free RV Moving Quotes</title>
...
<div class='main-wrapper content'>
	<section class="relative software_slider" style="padding-top:105px;background: url('img/2rv.jpg') no-repeat fixed 0px -55px / 100% auto">
                  ...
                  <td><center><div class="relative" style="width: 80%;">
                    ...
                    <div class="relative" style="width: 80%;">
										<select class="styled" style="color:#717171;" name="vehicle_condition1">
                                            <option value="Operational">Select RV Condition:</option>
