...
$sql = 'SELECT l.* FROM leads l RIGHT JOIN quotes q ON l.id = q.lead_id ';
...
if (sizeof($search)) {
	$sql .= ' WHERE (' . implode(') AND (', $search) . ') AND q.authenticated = 0';
}else{
	$sql .= 'WHERE q.authenticated = 0';
}
...
<!-- END: div id=navigation -->
				<div id="content">
					...
					<div id="column1">
						...
						<?php if ($rs && !$rs->EOF) { ?>
							<form action="confirm.php" method="get" style="margin-bottom: 1em">
							<input type=hidden name=start_date value=<? echo $arrVals['start_date'];?>>
						<table class="dataSet">
							...
							<tr class="headerRow">
								...
								<th valign="bottom" align="center">Authenticate</th>
								<th valign="bottom" align="center">Delete</th>
							</tr>
							<?php
							...
							<tr bgcolor="<?php echo $SS->swap(); ?>">
								<td valign="top" width=100><a href="lead_details.php?id=<?php w((int) $rs->fields['id']); ?>" title="View Lead Details"><?php w($rs->fields['customername']); ?></a></td>
								<td valign="top" align="right" width=20><?php w($rs->fields['email']); ?></td>
								<td valign="top" align="right" width=100><?php w($rs->fields['phone']); ?></td>
								<td valign="top" align="center" width=100><?php w(myts_date($rs->fields['created_at'], 'Y-m-d')); ?></td>
								...
								<td valign="top" align="center" nowrap="nowrap"><a href="confirm.php?auth_id=<?php w((int) $rs->fields['id']); ?>" id="leads_d_<?php w((int) $rs->fields['id']); ?>_link" title="Authenticate Lead">Authenticate</a></td>
								<td valign="top" align="center" nowrap="nowrap"><a href="lead_delete.php?id=<?php w((int) $rs->fields['id']); ?>" id="leads_d_<?php w((int) $rs->fields['id']); ?>_link" title="Delete Lead">Delete</a></td>
