<?php
require_once('configs/international/config.inc.php');
...
if (isset($_POST['move_date_submit'])) {
...
$_POST['vehicle_pickup_state'] = $_POST['fromCountry'];
}
if (isset($_POST['toCountry'])) {
$_POST['vehicle_destination_state'] = $_POST['toCountry'];
}
...
if (getParam('frmSubmit') == 'true') {
  die('Die a horrible death');
	...
	if (strlen(trim($arrVals['vehicle_pickup_state'])) == 0) {
		$arrErr[] = form_error('Please enter the pickup country.', 'vehicle_pickup_state', 'state');
	}
	...
	if (strlen(trim($arrVals['vehicle_destination_state'])) == 0) {
		$arrErr[] = form_error('Please enter the destination country.', 'vehicle_destination_state', 'state');
	}
...
<head>
	...
	<title>International Vehicle Shipping Quotes | Free International Car Shipping Quotes</title>
...
<div class='main-wrapper content'>
	<section class="relative software_slider" style="padding-top:105px;background: url('img/2_3132013.JPG') no-repeat fixed 0px -100px / 100% auto;height:650px;">
              ...
              <form action="" method="post"><table style="width:100%;background-color:rgba(0, 0, 0, 0.3);;border-radius:14px;color:#FFFFFF;text-align:center;"><tbody><tr style="height:100px;vertical-align:top;"><td style="width:33%"><h1>Vehicle Information</h1></td><td style="width:33%"><h1>Trip Information</h1></td><td style="width:34%"><h1>Contact Details</h1></td></tr>
                <tr style="vertical-align:top;">
                  <td><center><div class="relative" style="width: 80%;">
                                        ...
                                        <input type="text" autocomplete="off" class="controls" placeholder="Enter Year" name="vehicle_year" value="<?php echo htmlspecialchars(getParam('vehicle_year')); ?>" required="required">


									</div>
                                    <br><br><div class="relative" style="width: 80%;">
                                    <input type="text" autocomplete="off" class="controls" placeholder="Enter Make" name="vehicle_make" value="<?php echo htmlspecialchars(getParam('vehicle_make')); ?>" required="required">
										</div>
                                    <br><br>
                                    <div class="relative" style="width: 80%;">
                                     <input type="text" autocomplete="off" class="controls" placeholder="Enter Model" name="vehicle_model" value="<?php echo htmlspecialchars(getParam('vehicle_model')); ?>" required="required">
                                        </div><br><br><br>

                  <!--  <div class="relative" style="width: 80%;">
										<select class="styled" style="color:#717171;" name="vehicle_condition1">
                                            <option value="Operational">Select Tailer/Equipment Condition:</option>
                  ...
                  <td><div class="control-group">
                                       <input type="text" autocomplete="off" name="from" id="geocomplete" class="controls" placeholder="From Zipcode or City/State" style="width:80%" value="<?php if (isset($_POST['from']) && !empty($_POST['from'])) { echo $_POST['from']; } ?>" hidden="hidden">
        ...
        <!-- old inputs <input type="text" id="fromCity" value="<?php if (isset($_POST['fromCity']) && !empty($_POST['fromCity'])) { echo $_POST['fromCity']; } ?>" name="locality" placeholder="Enter From City/Locality" class="controls">

        <input type="text" id="fromState" value="<?php if (isset($_POST['fromCountry']) && !empty($_POST['fromCountry'])) { echo $_POST['fromCountry']; } ?>" name="country_short" placeholder="Enter From Country" class="controls" required="required">
        -->
        <input type="text" id="fromCity" value="<?php if (isset($_POST['fromCity']) && !empty($_POST['fromCity'])) { echo $_POST['fromCity']; } ?>" name="fromCity" placeholder="Enter From City/Locality" class="controls">

        <input type="text" id="fromState" value="<?php if (isset($_POST['fromCountry']) && !empty($_POST['fromCountry'])) { echo $_POST['fromCountry']; } ?>" name="fromCountry" placeholder="Enter From Country" class="controls" required="required">

        <input type="text" id="fromCountry" value="<?php if (isset($_POST['fromState']) && !empty($_POST['fromState'])) { echo $_POST['fromState']; } ?>" name="administrative_area_level_1" hidden="hidden">
        </div>
                                       <br><center><img src="img/arrow-down-white.png"></center><br>
                                               <div class="toDetails">
        ...
        <!-- old inputs <input type="text" id="toCity" value="<?php if (isset($_POST['toCity']) && !empty($_POST['toCity'])) { echo $_POST['toCity']; } ?>" name="locality"  placeholder="Enter Destination City/Locality" class="controls">

        <input type="text" id="toState" value="<?php if (isset($_POST['toCountry']) && !empty($_POST['toCountry'])) { echo $_POST['toCountry']; } ?>" name="country_short" placeholder="Enter Destination Country" class="controls" required="required">
        -->
        <input type="text" id="toCity" value="<?php if (isset($_POST['toCity']) && !empty($_POST['toCity'])) { echo $_POST['toCity']; } ?>" name="toCity"  placeholder="Enter Destination City/Locality" class="controls">

        <input type="text" id="toState" value="<?php if (isset($_POST['toCountry']) && !empty($_POST['toCountry'])) { echo $_POST['toCountry']; } ?>" name="toCountry" placeholder="Enter Destination Country" class="controls" required="required">

        <input type="text" id="toCountry" value="<?php if (isset($_POST['toState']) && !empty($_POST['toState'])) { echo $_POST['toState']; } ?>" name="administrative_area_level_1" hidden="hidden">
        </div>
                                       <input type="text" autocomplete="off" name="to" id="geocomplete2" class="controls" placeholder="To Zipcode or City/State" style="width:80%" value="<?php if (isset($_POST['to']) && !empty($_POST['to'])) {  echo $_POST['to']; } ?>" hidden="hidden">

                                       <br><br><input type="text" class="datepicker" name="move_date" type="text" id="move_date" style="width:80%" placeholder="Estimated Move Date" data-value="<?php echo htmlspecialchars(getParam('move_date')); ?>" required="required">
                                    ...
                                    <div class="relative">
										<select name="caoch" class="styled">
                                         ...
                                         <input type="text" autocomplete="off" id="phone" class="controls" placeholder="Phone Number" style="width:80%" name="phone" value="<?php echo htmlspecialchars(getParam('phone')); ?>" required="required"> <!-- data-pattnern="^[0-9]+$" -->
                                           ...
                                           <br><input type="checkbox" value="checked" id="moving" name="moving"><span style="font-family:'Times New Roman';font-size:17px;"> Please also send me a home mover quote.</span><br><br>
                                           <textarea autocomplete="off" id="comments" class="controls" placeholder="Comments" style="width:80%" name="comments"><?php echo htmlspecialchars(getParam('comments')); ?></textarea>

                            <br><!--<input type="checkbox" value="checked" id="moving" name="moving">Please also send me a home mover quote. -->
                            <br><br>
                            </div>
                              <!--   <div class='control-group'>
    ...
    <h3 class='slide-title text-center'>How It Works</h3><br><br><br>
		...
		<div class="spacer6"></div>
			...
			<div class="row trainings" id='trainings1'>
				<a href="vehicle-shipping.php"><div class="col-md-2-5 col-xs-6 hov1">
					<figure class='thumbnails'>
				...
				<a href="motorcycle-shipping.php"><div class="col-md-2-5 col-xs-6 hov2">
					<figure class='thumbnails'>
				...
				<a href="boat-shipping.php"><div class="col-md-2-5 col-xs-6 hov3">
					<figure class='thumbnails'>
				...
				<a href="rv-shipping.php"><div class="col-md-2-5 col-xs-6 hov4">
					<figure class='thumbnails'>
                ...
                <a href="trailer-shipping.php"><div class="col-md-2-5 col-xs-6 hov4">
					<figure class='thumbnails'>
						<i><img src="img/sprite/containerW.png" style="width:90px;position:relative;top:-5px;" alt="" /> </i>
					</figure>
					<h4 class='xxsmall-h text-center transition-h'>Trailer & Equipment</h4>
					<div class="full-text">
						<!-- text here -->
					</div>
				</div></a>
		...
		<div class="container">
			<ul class="aboutUs-slider unstyled">
				<li>
					...
					<div class="quote">
					The convenience while moving was absolutely worth every dollar I spent. The competative bids I got from haulingdepot.com made sure I got the best deal. Thanks.
					</div>
