...
<head>
	...
	<title>Vehicle Shipping Leads For Brokers | Haulingdepot.com</title>
...
<div class='main-wrapper content'>
				...
				<li class='firstslide'>
					<div class="container relative body-slide">
						<div class="list-forstart fin_1">
							<h2 class='h-Bold'>High Quality Leads</h2>
							<!--<p class='desc'>Vestibulum auctor aliquet lectus id rutrum. In hac habitasse platea dictumst. Ut luctus id turpis ac auctor. Morbi eleifend id arcu ac auctor nec tempor.</p>
							--><ul class='ul-list-slider Open-sansR'>
								<li>Cutting Edge Quality Assurance</li>
								<li>Unlimited Lead Packages Available</li>
								<li>Perfectly Integrates into jTracker and more!</li>
							</ul>
						</div>
						<div class="clearfix"></div>
						<div class="fin_2 dv2 ver2">
							<a href="http://www.haulingdepot.com/vehicle-shipping.php" class='btn submit no-mar dark-blue-btn a-trig'>The Data</a>
							<a href="#myModal" data-toggle="modal" role="button" class='btn submit a-trig glam-btn'>Register Now</a>
						</div>
					</div>
			...
			<!--	<li class='secondslide'>
					<div class="container relative body-slide">
						<div class="list-forstart fin_1">
							...
							<p class='desc'>Ut luctus id turpis ac auctor. Quisque vel neque quis nulla scelerisque cursus sed at lorem. Integer at vehicula est.</p>
							<ul class='ul-list-slider Open-sansR'>
						...
						<div class="clearfix"></div>
						<div class="fin_2 dv2 ver2">
							<a href="http://footage.shutterstock.com/clip-1881004-stock-footage-slo-motion-lemon-falling-into-wedges-against-black-drop.html?src=rel/1878937:2" class='btn submit no-mar dark-blue-btn a-trig'>Take a Demo</a>
							<a href="#myModalform" data-toggle="modal" role="button" class='btn submit a-trig glam-btn'>Register Now</a>
						</div>
					</div>
					<div class="img-slider slide-man2 fin_2"></div>
				</li>
				<li class='thirstslide'>
					<div class="container relative body-slide">
						<div class="list-forstart fin_1">
							<h2 class='h-Bold'>For the Best</h2>
							<p class='desc'>Donec quis leo varius, consectetur massa vitae, adipiscing magna. Cum sociis natoque penatibus et magnis dis parturient montes </p>
							<ul class='ul-list-slider Open-sansR'>
								<li>Curabitur Tempor Sapien</li>
					...
					<div class="img-slider slide-man3 fin_2"></div>
				</li> -->
			</ul>
		</div>
	</section>
    ...
    <h3 class='slide-title text-center'>How It Works</h3><br><br><br>
		...
		<div class="spacer6"></div>
			<h2 class='text-center xxh-Bold'>Leads We Offer</h2>
			<h3 class='text-center xmedium-h'></h3>
...
<div id="myModal" class="modal fade" tabindex="-1" aria-hidden="true">
	<div class="modal-wr">
		...
		<form id='contact' action="request-form.php" method="post" accept-charset="utf-8" role="form">
			...
			<div class='control-group'>
				<input type="text" name='email' value='' placeholder='Enter your email' class='insert-attr' data-required>
			</div>
			<div class='control-group'>
				<input type="text" name='message' placeholder='Enter your phone number' data-required>
			</div>
