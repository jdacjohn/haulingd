              ...
              <form action="contactform.php" method="post"><table style="width:100%;background-color:rgba(0, 0, 0, 0.3);;border-radius:14px;color:#FFFFFF;text-align:center;"><tbody><tr style="height:100px;vertical-align:top;"><td style="width:33%"><h1>Vehicle Information</h1></td><td style="width:33%"><h1>Trip Information</h1></td><td style="width:34%"><h1>Contact Details</h1></td></tr>
                <tr style="vertical-align:top;">
                  ...
                  <div class="relative" style="width: 80%;">
										...
										<select name="vehicle_year" id="car-years" class="styled" style="color:#717171;">
                                        <option value="SelectYear">Select Year</option>
                                        </select>

									</div>
                                    <br><br><div class="relative" style="width: 80%;">
										<select name="vehicle_make" id="car-makes" class="styled" style="color:#717171;">
                                        <option value="SelectYear">Select Make</option>
                                        </select></div>
                                    <br><br>
                                    <div class="relative" style="width: 80%;">
									    <select name="vehicle_model" id="car-models" class="styled" style="color:#717171;">
                                    ...
                                    <div class="relative">
										<select name="caoch" class="styled">
                                         ...
                                         <input type="text" autocomplete="off" id="phone" class="controls" placeholder="Phone Number" style="width:80%" name="phone" required="required"> <!-- data-pattnern="^[0-9]+$" -->
                                           ...
                                           <textarea autocomplete="off" id="comments" class="controls" placeholder="Comments" style="width:80%" name="comments"></textarea><br>
                            </div>
                              <!--   <div class='control-group'>
...
<center>
								 <button type="submit" value="" class="btn submit sub-form" name="submit" style="width:90%">Generate my free quotes now</button><br></center>
