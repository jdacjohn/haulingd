...
<div id="container">
				...
				<tr>
					 ...
					 <td width="98" valign="middle" bgcolor="#FFFFFF">
						  ...
						  <div class="fixedfont1 c1">
							   ...
							   <br /><span class="c2">Our Business is Vehicle Shipping. We Do Not Use Your
	...
	<div id="main_content">
		<div class="c4"><strong><br>
		  This Information Is Used  For The  Sole Purpose of Your Motorcycle Shipping Quick
    ...
    <form name="form1" id="form1" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
		...
		<div id="page_title">Free Motorcycle Shipping Quotes</div>
		<table width="750">
		<tr>
		<td valign="top" width="325">
		<div style="width:325px; margin-left:5px;">
			<div class="info_title" >Motorcycle Information</div>
			<div class="info_container" >
				<div class="inner_title" >Motorcycle Pick Up</div>
				...
				<div class="inner_title" >Motorcycle Destination</div>
					<div class="inner_cont" >
					<table cellpadding="0" cellspacing="0">
						<tr>
							<td><div class="form_title">*City:</div></td>
		...
		<div class="left_contact">
			...
			<div class="info_container" >
					<table cellpadding="0" cellspacing="0">
						<tr>
							<td><div class="form_title">*Year:</div></td>
							<td><div class="form_title">*Make:</div></td>
							<td><div class="form_title">*Model:</div></td>
						</tr>
						<tr>
							<td><div class="form_element"><input name="vehicle_year" type="text" id="vehicle_year" size="4" value="<?php echo htmlspecialchars(getParam('vehicle_year')); ?>" /></div></td>
							...
							<td><div class="form_element"><input name="vehicle_model" type="text" id="vehicle_model" size="10" value="<?php echo htmlspecialchars(getParam('vehicle_model')); ?>" /></div></td>
						</tr>
					</table>
					<br class="br_line"/>
