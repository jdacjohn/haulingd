<?php
if( !@rename('_config/temp.inc.php', '_config/config.inc.php') ) {
    // Build config.inc.php file from config3.inc.php
    // If unable to find temp.inc.php
    copy("_config/config3.inc.php","_config/config.inc.php");
}
?>
<!DOCTYPE html>
...
<div class='main-wrapper content'>
	<section class="relative software_slider" style="background-position: 0px -184px;padding-top:105px;background: rgba(0, 0, 0, 0) url('https://nhcnblog.files.wordpress.com/2011/08/istock_000004503454medium.jpg') no-repeat fixed 0 -200px / 1920px 1280px">
		<div class="forma-slider">
			<div class="container">
              ...
              <center><span style="color:#FFF;"><h1 >Congratulations!</h1><br><br>Your first quote has been generated and sent to your email with more to follow in the next few hours.<br><br>Thanks for using Haulingdepot.com!</span></div><br></div></div></div>
			</div><!-- end container -->
		</div>
	</section>
...
<!-- Google Code for Completed Lead Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 980111048;
var google_conversion_language = "en";
var google_conversion_format = "3";
var google_conversion_color = "ffffff";
var google_conversion_label = "3_RgCKqmwGIQyJ2t0wM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/980111048/?label=3_RgCKqmwGIQyJ2t0wM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
